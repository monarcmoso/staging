...
class SingPost_WebForms_Block_Adminhtml_Webforms_Grid
	extends Mage_Adminhtml_Block_Widget_Grid
{
	...
	protected function _prepareColumns()
	{
		...
		$this->addColumn('fields',array(
			...
			'index' => 'fields',
			'type'	=> 'number',
            'renderer' => 'SingPost_WebForms_Block_Adminhtml_Webforms_Renderer_Fields',
			'sortable' => false,
			'filter' => false
		));
		...
		$this->addColumn('results',array(
			...
			'index' => 'results',
			'type'	=> 'number',
			'renderer' => 'SingPost_WebForms_Block_Adminhtml_Webforms_Renderer_Results',
			'sortable' => false,
			'filter' => false
		));
		...
		$this->addColumn('last_result_time', array(
            ...
            'type'	=> 'number',
            'renderer' => 'SingPost_WebForms_Block_Adminhtml_Webforms_Renderer_Lastresult',
			'filter' => false,
			'sortable' => false,
		));
		...
		$this->addColumn('action',
			array(
				...
				'filter'    => false,
				'sortable'  => false,
				'renderer'	=> 'SingPost_WebForms_Block_Adminhtml_Webforms_Renderer_Action',
				'is_system' => true,
		));
