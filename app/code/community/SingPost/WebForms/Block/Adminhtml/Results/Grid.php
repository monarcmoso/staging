<?php
class SingPost_WebForms_Block_Adminhtml_Results_Grid
	extends Mage_Adminhtml_Block_Widget_Grid
{
	...
	{
        $renderer = 'SingPost_WebForms_Block_Adminhtml_Results_Renderer_Id';
        if($this->_isExport){
            $renderer = false;
        }
		...
		foreach($fields as $field){
			if($field->getType() != 'html'){
				...
				$config = array(
					...
					'renderer' => 'SingPost_WebForms_Block_Adminhtml_Results_Renderer_Value'
				);
				if($this->_isExport){
		...
		$config = array(
			...
			'align' => 'left',
			'index' => 'customer_id',
			'renderer' => 'SingPost_WebForms_Block_Adminhtml_Results_Renderer_Customer',
