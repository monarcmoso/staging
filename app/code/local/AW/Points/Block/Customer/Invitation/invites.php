...
class AW_Points_Block_Customer_Invitation_Invites extends Mage_Core_Block_Template
{
    /**
    ...
    protected function _toHtml()
    {
        ...
        $this->setTemplate("aw_points/customer/" . $magentoVersionTag . "/invitation/invites.phtml");
        $html = parent::_toHtml();
        return $html;
    }
}